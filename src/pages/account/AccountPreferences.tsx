import { useTheme, lightThemes, darkThemes, type Themes } from "@providers/ThemeProvider";
...
const AccountPreferences = () => {
  ...
  const ThemeItem = ({ dataTheme }: {dataTheme: Themes}) => (
    <div
      ...
      className={`bg-base rounded-2xl w-30 h-30 relative cursor-pointer ${currentTheme === dataTheme && "border-4 border-neutral-50"}`}
